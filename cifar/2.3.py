...
# 隐私预算为3时，our 谷歌 固定精度对比res34+cifar100
# 加载数据
with open('plant_data/2.2-our-dp3-42.55.txt', 'r') as f1:
    data1 = f1.readlines()  # 加载第一个文件的数据

with open('plant_data/2.2-gg-dp3-36.43.txt', 'r') as f2:
    data2 = f2.readlines()  # 加载第二个文件的数据

with open('plant_data/2.2-gd5-dp3-41.99.txt', 'r') as f3:
    data3 = f3.readlines()  # 加载第三个文件的数据

with open('plant_data/2.2-gd0.5-dp3-43.61.txt', 'r') as f4:
    data4 = f4.readlines()  # 加载第四个文件的数据

with open('plant_data/2.2-zxj-dp3-40.41.txt', 'r') as f5:

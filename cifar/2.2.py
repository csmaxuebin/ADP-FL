...
# 隐私预算为7时，our 谷歌 固定精度对比
# 加载数据
with open('plant_data/2.1-our-dp7-78.99.txt', 'r') as f1:
    data1 = f1.readlines()  # 加载第一个文件的数据

with open('plant_data/2.1-gg-dp7-78.39.txt', 'r') as f2:
    data2 = f2.readlines()  # 加载第二个文件的数据

with open('plant_data/2.1-gd4-dp7-77.61.txt', 'r') as f3:
    data3 = f3.readlines()  # 加载第三个文件的数据

with open('plant_data/2.1-gd0.5-dp7-77.73.txt', 'r') as f4:
    data4 = f4.readlines()  # 加载第四个文件的数据

with open('plant_data/2.1-zxj-dp7-75.13.txt', 'r') as f5:
